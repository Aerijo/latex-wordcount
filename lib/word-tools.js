...
function foldSection(editor, point, maxDepthString) {
  let textRange = getSectionRange(editor, point, maxDepthString, false);
...
function getSectionRange(editor, point, maxDepthString, includeSectionCommand = true) {
  /*
  ...
  */
  ...
  console.log(editor.getTextInBufferRange(sectionRange));
